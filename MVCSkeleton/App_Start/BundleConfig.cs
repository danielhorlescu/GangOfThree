...
namespace MVCSkeleton.Presentation.App_Start
{
    public class BundleConfig
    {
        ...
        {
            RegisterThirdPartyBundles(bundles);
        ...
        private static void RegisterCommonBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/Grid").Include(
                "~/Scripts/CustomScripts/Grid.js"));
        }

        private static void RegisterProductBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/Product").Include(
                "~/Scripts/CustomScripts/Product/List.js",
                "~/Scripts/CustomScripts/Product/Edit.js"));
        }

        private static void RegisterThirdPartyBundles(BundleCollection bundles)
        {
